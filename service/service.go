...
type Service interface {
	UserClusters(ctx context.Context) (*clusterclient.ClusterList, error)
}
...
// UserClusters takes context with user token and returned linked clusters for given user token
func (s *service) UserClusters(ctx context.Context) (*clusterclient.ClusterList, error) {
